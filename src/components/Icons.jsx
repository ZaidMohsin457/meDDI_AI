// Central icon library — all inline SVG, strokeWidth 1.5 unless noted
export const Icons = {
  Check: ({ cls = 'w-5 h-5' }) => (
...
/** Resolve an icon name string to a component (used with site-data feature.icon) */
export function resolveIcon(name, cls) {
  const I = Icons[name]
  return I ? <I cls={cls} /> : null
}
