...
export const about = {
  ...
  story: {
    ...
    paragraphs: [
      ...
      "meDDI AI was built to change this. It has grown into a serious product — drawing on cutting-edge Vision-Language Models, a Pakistan-specific drug database, and an offline-first mobile architecture. We are building the safety layer that Pakistan's pharmacy system urgently needs.",
    ],
  },
  mission: {
...
export const team = {
  ...
  members: [
    ...
    // ── Advisors & Partners ────────────────────────
    {
      ...
      initials: 'MZ',
      color: 'amber',
      photo: '/team/mohsin.jpeg',
      group: 'advisor',
      bio: 'Mohsin is a senior software engineer who led a 200K+ users/month SaaS platform (UltraCodes). A CV & 3D ML researcher, he advises meDDI AI on technical architecture, scalability, and product commercialization.',
    ...
    },
    {
      ...
      institution: 'Al-Raazi Hospital, Pakistan',
      email: '',
      initials: 'UZ',
      color: 'green',
      photo: '/team/usman.jpeg',
      group: 'advisor',
